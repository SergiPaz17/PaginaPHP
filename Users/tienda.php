...
<head>
    ...
    <link rel="stylesheet" href="./../Styles/styletienda.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="verCarrito.php">Carrito</a>
              </li>
              <li class="nav-item">
    ...
    while($fila = $resultado ->fetch_assoc()){
      ...
      echo "<form action='carrito.php?id=$id,producto=$producto,precio=$precio,categoria=$categoria,distribuidora=$distribuidora' method='POST'>";
      echo "<td> <input type='submit' class='fas fa-shopping-cart btn' name='carrito' ></td>";
      echo "</tr>";
      echo "</form>";
